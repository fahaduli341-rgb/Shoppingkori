...
export const AdminVendorsTab: React.FC = () => {
  const { vendors, addVendor, updateVendor, deleteVendor, products, showToast } = useShop();
            ...
            >
              ...
              <div className="pt-2 flex items-center justify-between border-t border-stone-100">
                ...
                <button
                  ...
                  className="px-2.5 py-1 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-1 text-xs font-semibold cursor-pointer"
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4 border border-stone-200 animate-in zoom-in-95 duration-150">
            ...
            <div className="text-center space-y-1.5">
              <h3 className="font-bold text-base text-stone-900">
                Delete Vendor? (ভেন্ডর মুছে ফেলুন)
              </h3>
              <p className="text-xs text-stone-600 leading-relaxed">
                Are you sure you want to permanently delete vendor store{' '}
                <strong className="text-stone-900 font-bold">"{vendorToDelete.storeName || vendorToDelete.shopName}"</strong>?
              </p>
              <p className="text-[11px] text-stone-400">
                All associated store credentials and merchant information will be removed.
              </p>
            </div>
